...
# Paths
# -----------------------------
DATA_PATH = Path("data/Sotheby's_Christie's_limpio.csv")
...
st.subheader("How named provenance becomes a market signal in art auctions")
...
col4.metric("Family collection works", (df["Provenance type"] == "Family Collection").sum())
